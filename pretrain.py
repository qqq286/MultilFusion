...
from qmodel.model_pretrain_ori import Fusion_Pretrain
from qmodel.model_ori import load_checkpoint

import qmodel.utils as utils
from qmodel.dataset import create_dataset, create_sampler, create_loader
...
def main(args, config):
    ...
    model = Fusion_Pretrain(config=config).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='D:/Fusion/configs/Pretrain.yaml')
    parser.add_argument('--checkpoint', default='med_pretrain_29.pth')  #med_pretrain_29.pth
    parser.add_argument('--output_dir', default='D:/Fusion/output/pretrain')

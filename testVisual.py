...
def main():
    ...
    parser.add_argument('--target_layer', default='vision_encoder.blocks.11.mlp', type=str, required=True,
                        help='目标层名称')
    parser.add_argument('--question', type=str, default='他在呢么了', help='问题文本')
    ...
    parser.add_argument('--checkpoint',
                        default='D:/Fusion/output/pretrain/2025-04-30_22-36/med_pretrain_49.pth')
    ...
    if isinstance(checkpoint, dict):
        ...
        model = Fusion_Pretrain(config=config)  # 初始化模型，可能需要传入参数
